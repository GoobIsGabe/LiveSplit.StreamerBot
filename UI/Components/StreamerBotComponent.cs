...
{
    public class StreamerBotComponent : IComponent
    {
        ...
        public StreamerBotSettings Settings { get; set; }
        ...
        // already added.
        public StreamerBotComponent(LiveSplitState state)
        {
            Settings = new StreamerBotSettings();
            InternalComponent = new InfoTextComponent("Streamer Bot", "Connect");
